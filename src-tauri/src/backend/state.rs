...
fn build_default_controls() -> ControlSnapshot {
    ...
    ControlSnapshot {
        ...
        personal_settings: PersonalSettings {
            ...
            cool_boost_enabled: false,
            custom_cpu_auto_enabled: false,
            custom_gpu_auto_enabled: false,
            custom_cpu_speed_percent: 50,
            custom_gpu_speed_percent: 50,
            sticky_keys_enabled: false,
            windows_menu_keys_enabled: true,
            temperature_unit_fahrenheit: false,
            keyboard_backlight_timeout_enabled: false,
            keyboard_lighting_dynamic: false,
            keyboard_brightness_percent: 75,
            keyboard_zone_1_enabled: true,
            keyboard_zone_2_enabled: true,
            keyboard_zone_3_enabled: true,
            keyboard_zone_4_enabled: true,
            keyboard_zone_1_color: "#ff3b00".into(),
            keyboard_zone_2_color: "#ff3b00".into(),
            keyboard_zone_3_color: "#ff3b00".into(),
            keyboard_zone_4_color: "#ff3b00".into(),
        },
    }
}
